...
class CallInfoSIPHeaderField(SIPHeaderField):
    ...
    #     answer = cls.newForFieldAttributes(fieldName="Call-Info", fieldValue=str(value))
    #     answer.value = value
    #     return answer
    ...
    #     super(CallInfoSIPHeaderField, self).clearAttributes()
    #     self._value = None

    # def parseAttributesFromRawString(self):
    #     super(CallInfoSIPHeaderField, self).parseAttributesFromRawString()
    #     self._value = None
    ...
    #         else:
    #             # Will get here is the Call-Info header field is present, but there is no value.
    #             self._value = None
    ...
    #     return super(CallInfoSIPHeaderField, self).isValid and self._value is not None
