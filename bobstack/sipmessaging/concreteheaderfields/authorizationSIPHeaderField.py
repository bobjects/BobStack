...
class AuthorizationSIPHeaderField(SIPHeaderField):
    ...
    #     answer = cls.newForFieldAttributes(fieldName="Authorization", fieldValue=str(value))
    #     answer.value = value
    #     return answer
    ...
    #     super(AuthorizationSIPHeaderField, self).clearAttributes()
    #     self._value = None

    # def parseAttributesFromRawString(self):
    #     super(AuthorizationSIPHeaderField, self).parseAttributesFromRawString()
    #     self._value = None
    ...
    #         else:
    #             # Will get here is the Authorization header field is present, but there is no value.
    #             self._value = None
    ...
    #     return super(AuthorizationSIPHeaderField, self).isValid and self._value is not None
