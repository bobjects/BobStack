...
class ToSIPHeaderField(SIPHeaderField):
    ...
    #     answer = cls.newForFieldAttributes(fieldName="To", fieldValue=str(value))
    #     answer.value = value
    #     return answer
    ...
    #     super(ToSIPHeaderField, self).parseAttributesFromRawString()
    #     self._value = None
    ...
    #         else:
    #             # Will get here is the To header field is present, but there is no value.
    #             self._value = None
    ...
    #     return super(ToSIPHeaderField, self).isValid and self._value is not None
