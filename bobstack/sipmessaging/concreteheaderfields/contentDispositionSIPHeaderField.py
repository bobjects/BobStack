...
class ContentDispositionSIPHeaderField(SIPHeaderField):
    ...
    #     answer = cls.newForFieldAttributes(fieldName="Content-Disposition", fieldValue=str(value))
    #     answer.value = value
    #     return answer
    ...
    #     super(ContentDispositionSIPHeaderField, self).clearAttributes()
    #     self._value = None

    # def parseAttributesFromRawString(self):
    #     super(ContentDispositionSIPHeaderField, self).parseAttributesFromRawString()
    #     self._value = None
    ...
    #         else:
    #             # Will get here is the Content-Disposition header field is present, but there is no value.
    #             self._value = None
    ...
    #     return super(ContentDispositionSIPHeaderField, self).isValid and self._value is not None
