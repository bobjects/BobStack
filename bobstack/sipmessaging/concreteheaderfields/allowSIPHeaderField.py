...
class AllowSIPHeaderField(SIPHeaderField):
    ...
    #     answer = cls.newForFieldAttributes(fieldName="Allow", fieldValue=str(value))
    #     answer.value = value
    #     return answer
    ...
    #     super(AllowSIPHeaderField, self).clearAttributes()
    #     self._value = None

    # def parseAttributesFromRawString(self):
    #     super(AllowSIPHeaderField, self).parseAttributesFromRawString()
    #     self._value = None
    ...
    #         else:
    #             # Will get here is the Allow header field is present, but there is no value.
    #             self._value = None
    ...
    #     return super(AllowSIPHeaderField, self).isValid and self._value is not None
