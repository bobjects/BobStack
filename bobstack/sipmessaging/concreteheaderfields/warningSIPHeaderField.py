...
class WarningSIPHeaderField(SIPHeaderField):
    ...
    #     super(WarningSIPHeaderField, self).clearAttributes()
    #     self._value = None

    # def parseAttributesFromRawString(self):
    #     super(WarningSIPHeaderField, self).parseAttributesFromRawString()
    #     self._value = None
    ...
    #         else:
    #             # Will get here is the Warning header field is present, but there is no value.
    #             self._value = None
    ...
    #     return super(WarningSIPHeaderField, self).isValid and self._value is not None
