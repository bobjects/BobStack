...
class DateSIPHeaderField(SIPHeaderField):
    ...
    #     super(DateSIPHeaderField, self).clearAttributes()
    #     self._value = None

    # def parseAttributesFromRawString(self):
    #     super(DateSIPHeaderField, self).parseAttributesFromRawString()
    #     self._value = None
    ...
    #         else:
    #             # Will get here is the Date header field is present, but there is no value.
    #             self._value = None
    ...
    #     return super(DateSIPHeaderField, self).isValid and self._value is not None
