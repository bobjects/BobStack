...
class FromSIPHeaderField(SIPHeaderField):
    ...
    #     answer = cls.newForFieldAttributes(fieldName="From", fieldValue=str(value))
    #     answer.value = value
    #     return answer
    ...
    #     super(FromSIPHeaderField, self).parseAttributesFromRawString()
    #     self._value = None
    ...
    #         else:
    #             # Will get here is the From header field is present, but there is no value.
    #             self._value = None
    ...
    #     return super(FromSIPHeaderField, self).isValid and self._value is not None
