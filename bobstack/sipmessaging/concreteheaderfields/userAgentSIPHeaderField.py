...
class UserAgentSIPHeaderField(SIPHeaderField):
    ...
    #     answer = cls.newForFieldAttributes(fieldName="User-Agent", fieldValue=str(value))
    #     answer.value = value
    #     return answer
    ...
    #     super(UserAgentSIPHeaderField, self).clearAttributes()
    #     self._value = None

    # def parseAttributesFromRawString(self):
    #     super(UserAgentSIPHeaderField, self).parseAttributesFromRawString()
    #     self._value = None
    ...
    #         else:
    #             # Will get here is the User-Agent header field is present, but there is no value.
    #             self._value = None
    ...
    #     return super(UserAgentSIPHeaderField, self).isValid and self._value is not None
