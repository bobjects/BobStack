...
class WWWAuthenticateSIPHeaderField(SIPHeaderField):
    @classmethod
    def newForAttributes(cls, fieldName="WWW-Authenticate", fieldValue=""):
        return cls.newForFieldAttributes(fieldName=fieldName, fieldValue=fieldValue)

    # @classmethod
    # def newForAttributes(cls, value=0):
    #     answer = cls.newForFieldAttributes(fieldName="WWW-Authenticate", fieldValue=str(value))
    #     answer.value = value
    #     return answer
    ...
    #     super(WWWAuthenticateSIPHeaderField, self).clearAttributes()
    #     self._value = None

    # def parseAttributesFromRawString(self):
    #     super(WWWAuthenticateSIPHeaderField, self).parseAttributesFromRawString()
    #     self._value = None
    ...
    #         else:
    #             # Will get here is the WWW-Authenticate header field is present, but there is no value.
    #             self._value = None
    ...
    #     return super(WWWAuthenticateSIPHeaderField, self).isValid and self._value is not None
