...
class RecordRouteSIPHeaderField(SIPHeaderField):
    ...
    #     answer = cls.newForFieldAttributes(fieldName="Record-Route", fieldValue=str(value))
    #     answer.value = value
    #     return answer
    ...
    #     super(RecordRouteSIPHeaderField, self).parseAttributesFromRawString()
    #     self._value = None
    ...
    #         else:
    #             # Will get here is the Record-Route header field is present, but there is no value.
    #             self._value = None
    ...
    #     return super(RecordRouteSIPHeaderField, self).isValid and self._value is not None
