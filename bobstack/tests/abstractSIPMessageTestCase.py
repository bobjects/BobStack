...
class AbstractSIPMessageTestCase(TestCase):
    ...
    def runAssertionsForSIPMessage(self, a_sip_message):
        ...
        a_sip_message.header.addHeaderFieldAfterHeaderFieldsOfSameClass(ViaSIPHeaderField.new_for_attributes(host='localhost', transport='TLS'))
        ...
        a_sip_message.header.addHeaderFieldBeforeHeaderFieldsOfSameClass(ViaSIPHeaderField.new_for_attributes(host='localhost', transport='TCP'))
