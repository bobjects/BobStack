...
class TestTCPTransportConnection(AbstractTransportConnectionTestCase):
    ...
    def run_00_initialSanityCheck(self):
        ...
        self.assertEqual('TCP', self.transport1.transport_parameter_name)
        ...
        self.assertEqual('TCP', self.transport2.transport_parameter_name)
        ...
        self.assertEqual('TCP', self.transport3.transport_parameter_name)
