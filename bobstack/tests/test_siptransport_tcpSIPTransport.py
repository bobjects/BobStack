...
class TestTCPTransportConnection(AbstractTransportConnectionTestCase):
    ...
    def run_07_sendRequestsVerifyReceipt(self):
        ...
        self.assertEqual(self.sampleRequest.raw_string, self.receivedRequests[0].sipMessage.raw_string)
        ...
        self.assertEqual(self.sampleRequest2.raw_string, self.receivedRequests[1].sipMessage.raw_string)
    ...
    def run_08_sendResponsesVerifyReceipt(self):
        ...
        self.assertEqual(self.sampleResponse.raw_string, self.receivedResponses[0].sipMessage.raw_string)
        ...
        self.assertEqual(self.sampleResponse2.raw_string, self.receivedResponses[1].sipMessage.raw_string)
    ...
    def made_connection_event_handler(self, a_tcp_sip_transport_connection):
        self.connectedConnections.append(a_tcp_sip_transport_connection)
    ...
    def lost_connection_event_handler(self, a_tcp_sip_transport_connection):
        if a_tcp_sip_transport_connection in self.connectedConnections:
            self.connectedConnections.remove(a_tcp_sip_transport_connection)
